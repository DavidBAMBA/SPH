...
x = np.zeros(N)
xs1 = np.linspace(0.0, 0.6, 320, endpoint=False) # 320 left of the wall
xs2 = np.linspace(0.6, 1.2, 80, endpoint=False) # 80 right of the wall
x[:len(xs1)] = xs1
x[-len(xs2):] = xs2
...
rho[-len(xs2):] = 0.2 # Density of the particles in the right
